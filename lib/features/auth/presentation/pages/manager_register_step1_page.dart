...
class ManagerRegisterStep1Page extends StatefulWidget {
  const ManagerRegisterStep1Page({super.key});

  @override
  State<ManagerRegisterStep1Page> createState() =>
      _ManagerRegisterStep1PageState();
}

class _ManagerRegisterStep1PageState extends State<ManagerRegisterStep1Page> {
